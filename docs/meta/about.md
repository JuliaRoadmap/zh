...
“工作流程”目录下包含开发时的各个建议及深入阅读内容的推荐，其中你可以根据[包简介](../workflow/introduction.md)的指示学会寻找、使用与制作你专业所需的包，如：数据科学可能需要阅读 `Dates`, `DataFrames` 与 `Makie` 的相关内容。[^ds]
...
本文档需要持续改进，欢迎您的贡献！[在此阅读](https://github.com/JuliaRoadmap/zh/blob/master/CONTRIBUTING.md)如何贡献。
